...
def run_stage(round_id:str,stage:str,max_seconds:int=120) -> None:
    ...
    if stage not in ('smoke','prepare','evaluate','report') or round_id not in ('16','17'):
        raise ValueError('Invalid stage or phase')
    limits={'smoke':90,'prepare':300,'evaluate':180,'report':120}
...
if __name__=='__main__':
    ...
    parser.add_argument('round',choices=['16','17'])
    parser.add_argument('stage',choices=['smoke','prepare','evaluate','report'])
