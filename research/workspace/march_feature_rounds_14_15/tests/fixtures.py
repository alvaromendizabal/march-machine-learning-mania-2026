...
def build_fixture(root):
    root=Path(root);args={k:root/n for k,n in [('kit','march_feature_rounds_14_15'),('repo','repo'),
    ...
    for name in w.SOURCES+['package_returns.py','14_ranking_resolution.ipynb','15_common_opponents.ipynb']:
        src=ROOT/name
        if src.exists():
