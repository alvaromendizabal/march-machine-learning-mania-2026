...
https://kenpom.com/blog/offense-vs-defense-assist-rate/
 ...
 ## Limits / limitations
 All-season audit120 seconds (zero fits), smoke90, smoke replay90, remaining preparation300, evaluation180, reporting120. Two threads; 6GiB worker RSS guard. Actual runtime/cost unmeasured. Known sources and checkpoints must exist; no rebuild or download on missing inputs. Assist rate describes scoring style and can be influenced by scorekeeping and shot mix; higher is not inherently better. Rebounding opportunities inferred from box scores omit team/dead-ball rebound detail.
